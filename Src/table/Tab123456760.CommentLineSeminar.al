table 123456760 "Comment Line Seminar"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Table Name';
            OptionCaption = 'G/L Account,Customer,Vendor,Item,Resource,Job,,Resource Group,Bank Account,Campaign,Fixed Asset,Insurance,Nonstock Item,IC Partner,Seminar';
            OptionMembers = "G/L Account",Customer,Vendor,Item,Resource,Job,,"Resource Group","Bank Account",Campaign,"Fixed Asset",Insurance,"Nonstock Item","IC Partner",Seminar;
        }
        field(2; "No."; Code[20])
        {
            Caption = 'No.';
    ...
    local procedure OnAfterSetUpNewLine(var CommentLineRec: Record "Comment Line Seminar"; var CommentLineFilter: Record "Comment Line Seminar")
    begin
    end;
}
